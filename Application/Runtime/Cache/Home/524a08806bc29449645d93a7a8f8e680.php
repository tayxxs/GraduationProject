...
<!-- Theme style -->
<link href="/www/Public/adminlte/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
<!-- iCheck -->
<link href="/www/Public/adminlte/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
...
<div class="register-box">
    ...
    <div class="register-box-body">
        ...
        <form action="/www/index.php/Home/Login/register.html" method="post">
...
<!-- iCheck -->
<script src="/www/Public/adminlte/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
<script>
    $(function () {
        $('input').iCheck({
